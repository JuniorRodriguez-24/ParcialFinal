package com.example.parcialfinal.ui.theme.ui.screens
...
import com.example.parcialfinal.model.Cita
import com.example.parcialfinal.obtenerMensajeDelDia
...
fun PantallaDatosPersonales(navController: NavController) {
    ...
    // Obtenemos el contexto (necesario para Volley)
    val context = LocalContext.current
    // Estado para guardar el mensaje. Inicia diciendo "Cargando..."
    var mensajeDelDia by remember { mutableStateOf("Cargando mensaje del día...") }

    // LaunchedEffect(Unit) ejecuta la petición UNA SOLA VEZ al abrir la pantalla
    LaunchedEffect(Unit){
